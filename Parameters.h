...
constexpr EvalParameters default_dwarf_eval{29, 400, 9, 1, 0, 27, 66, true}, default_troll_eval{8, 400, 20, 1, 0, 16, 133, true};

constexpr int assertion_level = 4;

// for main
constexpr uint32_t num_bits = 15;
constexpr uint32_t game_length = 200;
constexpr uint32_t num_threads = 20;

// for Search
constexpr bool use_extensions = false;
constexpr bool shuffled_pv_search = false;
